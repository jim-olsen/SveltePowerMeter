...
def dataReport():
    try:
        ...
        weatherData.update({
            ...
            'rain_total': float(request.form.get('yrain_piezo', 0)),
...
#            'inTemp_F': request.form.get('tempinf', 0),
            ...
            'daily_rain': float(request.form.get('drain_piezo', 0)),
            'wind_average': request.form.get('windspeedmph', 0),
            'rain_in': float(request.form.get('drain_piezo', 0)),
            ...
            'hourRain_in': float(request.form.get('hrain_piezo', 0)),
